...
private:
  ...
  // When SpirvDebugFunctionDeclaration does not contain meaningful
  // information (because the information is not generated by SpirvEmitter),
  // we want to generate it for debug composite type information.
  void generateFunctionInfo(SpirvDebugFunctionDeclaration *fn,
